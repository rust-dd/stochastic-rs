...
$env:TEMP = "C:\Temp"
$env:TMP = "C:\Temp"
cmd /c 'call "C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Auxiliary\Build\vcvars64.bat" && nvcc -O3 -use_fast_math -arch=sm_89 -shared fgn.cu -o ./fgn_windows/fgn.dll -lcufft -lcurand'
```
...
```toml
[dependencies]
stochastic-rs = { version = "0.15", features = ["cuda", "f64"] }
```
...
let fgn = FGN::new(0.7, 1000, Some(1.0), Some(10000));
