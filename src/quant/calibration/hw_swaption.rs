...
use crate::quant::instruments::option::caplet::black_forward_caplet;
use crate::quant::instruments::option::jamshidian::price_jamshidian_hull_white;
use crate::quant::instruments::option::types::SwaptionDirection;
...
struct CurveSnapshot {
  times: Vec<f64>,
  rates: Vec<f64>,
  method: crate::quant::curves::InterpolationMethod,
}
