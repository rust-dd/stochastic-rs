...
└── stochastic-rs-py/                 — pyo3 cdylib (274 entries: 256 PyO3 classes + 18 pyfunctions, across distributions/stochastic/quant/copulas/stats; AI bindings deferred to 2.x). Built via `maturin` (see pyproject.toml `[tool.maturin] manifest-path`)
```
