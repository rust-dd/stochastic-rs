...
└── stochastic-rs-py/                 — pyo3 cdylib (239 entries: 223 PyO3 classes + 16 pyfunctions, across distributions/stochastic/quant/copulas/stats; AI bindings deferred to 2.x). Built via `maturin` (see pyproject.toml `[tool.maturin] manifest-path`)
```
