...
fn stochastic_rs_python(m: &Bound<'_, PyModule>) -> PyResult<()> {
  ...
  use stochastic_rs_stochastic::interest::black_karasinski::PyBlackKarasinski;
  use stochastic_rs_stochastic::interest::cheyette::PyCheyette;
  use stochastic_rs_stochastic::interest::cir_pp::PyCirPlusPlus;
  ...
  m.add_class::<PyAitSahalia>()?;
  m.add_class::<PyBessel>()?;
  m.add_class::<PyBrownianBridge>()?;
  m.add_class::<PyCkls>()?;
  m.add_class::<PyDisplacedDiffusion>()?;
  m.add_class::<PyFellerRoot>()?;
  m.add_class::<PyHawkesJD>()?;
  m.add_class::<PyHyperbolic>()?;
  m.add_class::<PyHyperbolic2>()?;
  m.add_class::<PyLinearSDE>()?;
  m.add_class::<PyLogistic>()?;
  m.add_class::<PyModifiedCIR>()?;
  m.add_class::<PyNonLinearSDE>()?;
  m.add_class::<PyPearson>()?;
  m.add_class::<PyRadialOU>()?;
  m.add_class::<PySquaredBessel>()?;
  m.add_class::<PyTengSCP>()?;
  m.add_class::<PyThreeHalf>()?;
  ...
  m.add_class::<PyBlackKarasinski>()?;
  m.add_class::<PyCirPlusPlus>()?;
  ...
  use stochastic_rs_quant::python::PyHullWhiteCallableBond;
  ...
  m.add_class::<PyHullWhiteCallableBond>()?;
  ...
  use stochastic_rs_stats::python::PyDfa;
  use stochastic_rs_stats::python::PyFdResult;
  ...
  use stochastic_rs_stats::python::PyGph;
  use stochastic_rs_stats::python::PyHestonMLE;
  use stochastic_rs_stats::python::PyHestonNMLECEKF;
  use stochastic_rs_stats::python::PyHiguchi;
  use stochastic_rs_stats::python::PyHurstResult;
  ...
  use stochastic_rs_stats::python::PyRescaledRange;
  ...
  use stochastic_rs_stats::python::PyVariations;
  use stochastic_rs_stats::python::PyVariogram;
  use stochastic_rs_stats::python::PyWavelet;
  use stochastic_rs_stats::python::PyWhittle;
  ...
  m.add_class::<PyHurstResult>()?;
  m.add_class::<PyRescaledRange>()?;
  m.add_class::<PyDfa>()?;
  m.add_class::<PyGph>()?;
  m.add_class::<PyWavelet>()?;
  m.add_class::<PyFdResult>()?;
  m.add_class::<PyHiguchi>()?;
  m.add_class::<PyVariogram>()?;
  m.add_class::<PyWhittle>()?;
  m.add_class::<PyVariations>()?;
  ...
  )?)?;
  {
    ...
    m.add_class::<PyEwmaVariance>()?;
    m.add_class::<PyLeeMyklandJumpTest>()?;
    m.add_class::<PyHarRv>()?;
    ...
    m.add_function(pyo3::wrap_pyfunction!(
      stochastic_rs_stats::python::mean_excess,
      m
    )?)?;
  }
