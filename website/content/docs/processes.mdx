...
(`cubecl-cuda` / `cubecl-wgpu`), `MetalNative` (`metal`), `Accelerate`
...
|---|---|---|---|
| `CubeCl` | `cubecl-cuda` / `cubecl-wgpu` | CUDA, Metal, Vulkan, WebGPU through CubeCL | `f32` |
...
gpu = srs.PyGbm(0.05, 0.2, 253, x0=100.0, t=1.0, seed=7, dtype="f32", device="gpu").sample_par(20_000)
```
</Tab>
</Tabs>
