...
surface covers **234 entries** — 218 PyO3 classes plus 16 free functions
across distributions, stochastic processes, pricers, calibrators,
copulas, and stats (13 of the classes additionally require the
`openblas` feature — see [Python bindings](/docs/python)).
