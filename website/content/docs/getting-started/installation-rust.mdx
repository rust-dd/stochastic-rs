...
```toml
[dependencies]
stochastic-rs-distributions = "3.0.0-rc.0"   # SIMD distribution sampling
stochastic-rs-stochastic = "3.0.0-rc.0"   # 131 process types
stochastic-rs-copulas = "3.0.0-rc.0"   # bivariate / multivariate copulas
stochastic-rs-stats = "3.0.0-rc.0"   # estimators
stochastic-rs-quant = "3.0.0-rc.0"   # pricing / calibration / vol surface
stochastic-rs-ai = "3.0.0-rc.0"   # neural surrogates (candle)
```
