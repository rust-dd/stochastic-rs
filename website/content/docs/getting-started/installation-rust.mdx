...
```toml
[dependencies]
stochastic-rs-distributions = "3.0.0-beta.1"   # SIMD distribution sampling
stochastic-rs-stochastic = "3.0.0-beta.1"   # 127 process types
stochastic-rs-copulas = "3.0.0-beta.1"   # bivariate / multivariate copulas
stochastic-rs-stats = "3.0.0-beta.1"   # estimators
stochastic-rs-quant = "3.0.0-beta.1"   # pricing / calibration / vol surface
stochastic-rs-ai = "3.0.0-beta.1"   # neural surrogates (candle)
```
