...
```toml
[dependencies]
stochastic-rs-distributions = "3.0.0-beta.3"   # SIMD distribution sampling
stochastic-rs-stochastic = "3.0.0-beta.3"   # 127 process types
stochastic-rs-copulas = "3.0.0-beta.3"   # bivariate / multivariate copulas
stochastic-rs-stats = "3.0.0-beta.3"   # estimators
stochastic-rs-quant = "3.0.0-beta.3"   # pricing / calibration / vol surface
stochastic-rs-ai = "3.0.0-beta.3"   # neural surrogates (candle)
```
