...
```toml
[dependencies]
stochastic-rs-distributions = "2.5"   # SIMD distribution sampling
stochastic-rs-stochastic = "2.5"   # 120+ process types
stochastic-rs-copulas = "2.5"   # bivariate / multivariate copulas
stochastic-rs-stats = "2.5"   # estimators
stochastic-rs-quant = "2.5"   # pricing / calibration / vol surface
stochastic-rs-ai = "2.5"   # neural surrogates (candle)
stochastic-rs-viz = "2.5"   # plotly grid plotter
```
