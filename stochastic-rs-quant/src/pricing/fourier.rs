...
impl FourierModelExt for DoubleHestonFourier {
  ...
  fn cumulants(&self, t: f64) -> Cumulants {
    ...
    // Mean of integrated variance: \int_0^t E[v_j] du = theta_j t + (v_j0 - theta_j)(1 - e^{-kappa_j t})/kappa_j
    ...
    // Variance of log-return ≈ integrated expected variance (leading order).
