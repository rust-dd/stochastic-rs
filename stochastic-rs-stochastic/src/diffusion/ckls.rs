...
pub struct Ckls<T: FloatExt, S: SeedExt = Unseeded, B = Cpu> {
  ...
  pub theta4: T,
  /// Number of points sampled along the CKLS path.
  pub n: usize,
  /// Initial value X₀ of the CKLS path.
  pub x0: Option<T>,
...
/// The Euler engine's view of CKLS: four parameters, one declaration, and
/// every backend serves it.
impl<T: FloatExt, S: SeedExt, B: crate::euler::EulerBackend<T>> crate::euler::EulerCoefficients<T>
  for Ckls<T, S, B>
{
  fn euler_spec(&self) -> crate::euler::EulerSpec<T> {
    crate::euler::EulerSpec::Ckls {
      theta1: self.theta1,
      theta2: self.theta2,
      theta3: self.theta3,
      theta4: self.theta4,
