...
//! --include='*.rs'` finds 125 concrete implementations outside
...
//! volterra 1 — 125 total, split below into one submodule per directory
...
//! reports all 125 checks as before). **When a new process type is added,
